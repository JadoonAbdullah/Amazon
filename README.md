...
An example project demonstrating automated tests using JavaScript-based end-to-end testing framework Cypress with Page Object Model pattern.

## Application Under Test

We are using Amazon as the Application Under Test.
